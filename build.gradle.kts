...
// Publishing coordinates only. The generated code keeps its com.codeinc.flipcash.gen.*
...
mavenPublishing {
    ...
    coordinates(group.toString(), "flipcash2-client-protocol", version.toString())

    pom {
        name.set("Flipcash client protocol")
        description.set("Generated Kotlin client for the Flipcash gRPC contract")
        inceptionYear.set("2026")
        url.set("https://github.com/code-payments/flipcash2-client-protocol")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/code-payments/flipcash2-client-protocol")
            connection.set("scm:git:git://github.com/code-payments/flipcash2-client-protocol.git")
            developerConnection.set("scm:git:ssh://git@github.com/code-payments/flipcash2-client-protocol.git")
        }
    }
}
...
// building under, and the upstream commit flipcash2.lock is pinned at. `sync-protos.sh
// --local` writes `commit: LOCAL`, so a composite-build consumer sees LOCAL with no extra
// handling.
abstract class GenerateContractInfo : DefaultTask() {
    ...
    fun generate() {
        ...
        val dir = outputDir.get().asFile.resolve("com/codeinc/flipcash/gen")
        dir.mkdirs()
        dir.resolve("Flipcash2ContractInfo.kt").writeText(
            """
            // Generated by the generateContractInfo Gradle task. Do not edit.
            package com.codeinc.flipcash.gen

            public object Flipcash2ContractInfo {
...
val generateContractInfo = tasks.register<GenerateContractInfo>("generateContractInfo") {
    lockFile.set(layout.projectDirectory.file("flipcash2.lock"))
